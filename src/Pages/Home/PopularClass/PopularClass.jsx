...
<span className="text-sm flex gap-2 justify-between items-center text-gray-500 dark:text-gray-400">< FaUserFriends></FaUserFriends> 1200+ </span>
        ...
        <div className="flex mt-4 space-x-3 md:mt-6">
          ...
          <div className="flex flex-col items-center pb-10">
        <img className="w-40 h-40 md:w-64 md:h-56 mb-3 rounded-full shadow-lg" data-aos="fade-in"
                data-aos-once="false" src="https://nirvana.axiomthemes.com/wp-content/uploads/2017/02/promo-1.png" alt="Bonnie image"/>
        <h5 className="mb-1 text-xl font-medium text-gray-900 dark:text-white">Hands and Body Yoga
</h5>
