    ...
    return (
        <>
            ...
            >
                <SwiperSlide>
                    <div
                        className="hero min-h-screen" data-aos="zoom-in-down"
                        data-aos-once="false"
                ...
                <SwiperSlide>
                    <div
                        className="hero min-h-screen bg-cover"  data-aos="zoom-in-up"
                        data-aos-once="false"
                        style={{
                ...
                <SwiperSlide>
                    <div
                        className="hero min-h-screen"  data-aos="zoom-in-out"
                        data-aos-once="false"
                    ...
                    >
                        ...
                        <div className="hero-content text-center text-neutral-content">
                            <div className="max-w-md">
                                <h1 className="mb-5 text-5xl font-bold">A Complete WorkOut from Head to Toes</h1>
                                <p className="mb-5">
                                    Provident cupiditate voluptatem et in. Quaerat fugiat ut assumenda excepturi exercitationem quasi. In deleniti eaque aut repudiandae et a id nisi.
                                </p>
                                <button className="btn btn-outline btn-warning">Explore more</button>
                ...
                <SwiperSlide>
                    <div
                        className="hero min-h-screen"  data-aos="zoom-in-right"
                        data-aos-once="false"
                    ...
                    >
                        ...
                        <div className="hero-content text-end text-neutral-content">
                            <div className="max-w-md">
                                <h1 className="mb-5 text-5xl font-bold"> Basic Yoga for Beginners</h1>
                                <p className="mb-5">
                                    Provident cupiditate voluptatem et in. Quaerat fugiat ut assumenda excepturi exercitationem quasi. In deleniti eaque aut repudiandae et a id nisi.
                                </p>
                                <button className="btn btn-outline btn-warning">Explore more</button>
                ...
                <SwiperSlide>
                    <div
                        className="hero min-h-screen"  data-aos="zoom-in-left"
                        data-aos-once="false"
                    ...
                    >
                        ...
                        <div className="hero-content text-center text-neutral-content ">
                            <div className="max-w-md">
                                <h1 className="mb-5 text-5xl font-bold">Keeping your in Best conditions</h1>
                                <p className="mb-5">
                                    Provident cupiditate voluptatem et in. Quaerat fugiat ut assumenda excepturi exercitationem quasi. In deleniti eaque aut repudiandae et a id nisi.
                                </p>
                                <button className="btn btn-outline btn-accent">Explore more</button>
