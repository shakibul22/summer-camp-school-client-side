                ...
                <div className=" p-1  rounded-lg md:p-8 " id="stats" role="tabpanel" aria-labelledby="stats-tab">
                    <div className="grid max-w-screen-xl grid-cols-2 gap-8 p-4 mx-auto text-white sm:grid-cols-3 xl:grid-cols-6 sm:p-8">
                        <div className="flex flex-col items-center justify-center">
                            <dt className="mb-2 text-3xl text-gray-500 font-extrabold">73k+</dt>
                            <dd className="text-gray-500 dark:text-gray-400">Students</dd>
                        </div>
                        <div className="flex flex-col items-center justify-center">
                            <dt className="mb-2 text-3xl text-gray-500 font-extrabold">100+</dt>
                            <dd className="text-gray-500 dark:text-gray-400">Advantages</dd>
                        </div>
                        <div className="flex flex-col items-center justify-center">
                            <dt className="mb-2 text-3xl text-gray-500 font-extrabold">1000</dt>
                        ...
                        <div className="flex flex-col items-center justify-center">
                            <dt className="mb-2 text-3xl text-gray-500 font-extrabold">90+</dt>
                            <dd className="text-gray-500 dark:text-gray-400">Top Forbes companies</dd>
                        </div>
                        <div className="flex flex-col items-center justify-center">
                            <dt className="mb-2 text-3xl text-gray-500 font-extrabold">4k</dt>
                            <dd className="text-gray-500 dark:text-gray-400">Instructors</dd>
                        </div>
                    </div>


                    <h5 className="mb-2 text-3xl font-bold text-gray-900 dark:text-white">Work fast from anywhere</h5>
                    <p className="mb-5 text-base text-gray-500 sm:text-lg dark:text-gray-400">Stay up to date and move work forward with Yoga on iOS & Android. Download the app today.</p>
