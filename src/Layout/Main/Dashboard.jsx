...
import { FaHome, FaRegAddressBook, FaWallet, FaWatchmanMonitoring } from 'react-icons/fa';
                    ...
                    <div className="dropdown dropdown-end">
                        <label className="btn btn-ghost btn-circle avatar">
                            <div className="w-10 rounded-full">
                                <img src={user.photoURL} alt="Profile" title={user.displayName} className="h-8 w-8 rounded-full cursor-pointer mr-10" />
                            </div>
                        </label>
